...
//recode : Bii
//recode : Vegeta Network

// JANGAN DIJUAL MURAH APALAGI DI KASIH FREE!!
//=================================================//
require('./hwkal')
...
const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER ${botname}`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/c0c410dab4c782d6404c0.jpg',"thumbnail": thumb,"sourceUrl": `https://chat.whatsapp.com/JGvGRES22WvJ41IIkgW7Gc`}}}, { quoted:m})} 
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `᭖͜͡Vegeta Offical`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;BiiofcBot,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/0fc4f6dbbc5d5f95ede6f.jpg' }}}}
...
var sanzytod = [
"_Hello My Name is VegetaOffcial_",
"_Base Script : HwMods_",
"_Recode : VegetaOffcial_",
...
case 'menu': 
var sanzytod = [
"_Hello My Name is RizalTY_",
"_Base Script : HwMods_",
"_Recode : RizalTzy_",
"_Website api : https://www.vegeta.cloud_",
"_Thanks_",
...
╰━━━━━━━━┈─◂
✦───『 *BLOCKIR AKSES*
│々 pengguna add (628xx)
│々 pengguna del (628xx)
│々 listban
╰━━━━━━━━┈─◂
✦───『 *CEK DATABASE*
│々 hapusdb (628xx@s.whatsapp.net)
│々 listdb
╰━━━━━━━━┈─◂
✦───『 *FITUR MENU*
│々 ɢᴀꜱᴍᴇɴᴜ
...
let { key } = await haikal.sendMessage(m.chat, { image: kalimage, caption: 'https://chat.whatsapp.com/JGvGRES22WvJ41IIkgW7Gc', contextInfo: { mentionedJid: [sender], forwardingScore: 9999, isForwarded: true }}) 
for (let i = 0; i < sanzytod.length; i++) {
await sleep(100)
...
if (!isCreator) return reply('Maaf, command ini hanya untuk pemilik.')
reply(`Wait Tuan Sc Sedang Kami Proses⏳`) 
const baby2 = await mediafireDl('https://www.mediafire.com/file/k13jxfbeimrrtjn/Sc+Gratis+By+Vegeta.zip/file')
haikal.sendMessage(from, { document : { url : baby2[0].link}, fileName : baby2[0].nama, mimetype: baby2[0].mime }, { quoted : fkontak}).catch ((err) => reply('*Failed to download File*'))
}
break
                case 'ambilsc9': {
...
case 'addprem':
if (!isCreator) return 
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 62895803540003`)
...
case 'pengguna':  {
if (!isCreator) return m.reply('*khusus Premium*')
if (!args[0]) return reply(`*Contoh : ${command} add 62895803540003*`)
if (args[1]) {
...
"sellerJid": "62895803540003@s.whatsapp.net",
...
break
//=================================================//
case 'sendrafa1' : case 'sendrafa2' : case 'sendrafa3' : {
...
break
//=================================================//
case 'sendrafa4' : case 'sendrafa5' : case 'sendrafa6' : {
if (!isCreator) return reply('*khusus Premium*')
await loading()
...
if (args[0].startsWith(`+62895803540003`)) return reply('Tidak bisa call ke nomor ini!')
...
mediaType:  1,
mediaUrl: 'https://wa.me/62895803540003',
title: `HW MODS WA`,
sourceUrl: `https://wa.me/62895803540003`, 
thumbnail: thumb
}
}})
break
...
if (!isCreator) return m.reply('*Khusus Premium*')
await loading ()
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 62895803540003@s.whatsapp.net`)
...
m.reply(`DONE BY Vegeta Network⚡
